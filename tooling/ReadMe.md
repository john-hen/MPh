...
* Run code coverage: `python tooling/coverage.py`
* Push to GitHub:
```console
...
git push origin 1.2
```
* Upload coverage report: `python tooling/codecov.py`
* Create new release on GitHub and add release notes.
* Publish to PyPI: `python tooling/publish.py`
